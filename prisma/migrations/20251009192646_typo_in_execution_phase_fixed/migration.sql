...
INSERT INTO "new_ExecutionPhase" ("completedAt", "creditsConsumed", "id", "inputs", "name", "node", "number", "outputs", "status", "userId", "workflowExecutionId") SELECT "completedAt", "creditsConsumed", "id", "inputs", "name", "node", "number", "outputs", "status", "userId", "workflowExecutionId" FROM "ExecutionPhase";

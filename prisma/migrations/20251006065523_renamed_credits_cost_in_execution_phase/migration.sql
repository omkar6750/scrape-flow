...
INSERT INTO "new_ExecutionPhase" ("StartedAt", "completedAt", "id", "inputs", "name", "node", "number", "outputs", "status", "userId", "workflowExecutionId") SELECT "StartedAt", "completedAt", "id", "inputs", "name", "node", "number", "outputs", "status", "userId", "workflowExecutionId" FROM "ExecutionPhase";
